public class Driver{
  public static void main(String[] args){
    ...
    //Testing toString()
    System.out.println("\n\n---Testing toString()---");
    System.out.println("mini|Should print 6 rows of 4 '_'s:" + mini.toString());
    System.out.println("a|Should print 8 rows of 8 '_'s:" + a.toString());
    //-------------------------------------------------------------------------//
    ...
    // System.out.println("Board a should NOT be modified:" +a.toString());
    // //-------------------------------------------------------------------------//
    ...
    // System.out.println("Board b should be modified:"+b.toString());
    // //-------------------------------------------------------------------------//
    // System.out.println("\nCase: Attempting to add a word to a negative index or an index too large");
    ...
    // System.out.println("Board b should NOT be modified:" +b.toString());
    // //-------------------------------------------------------------------------//
    // System.out.println("\nCase: Word is too long for given position");
